...
Run the MRI analysis.

The VMamba model generates the prediction and confidence score.

The XAI module generates a visualization to help show the important areas used by the model.

View the assessment and patient history.

Check the available reports.
